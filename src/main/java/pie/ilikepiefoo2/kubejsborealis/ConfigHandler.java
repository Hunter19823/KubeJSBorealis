    ...
    public static class Common {
        ...
        public Common(ForgeConfigSpec.Builder builder)
        {
            ...
            kubejsDocumentation = builder
                    .comment("Enable/Disable KubeJS Documentation Homepage")
                    .defineEnum("documentationHomePage",PageType.ENABLED);
            kubejsClassPage = builder
                    .comment("Enable/Disable All KubeJS Class Pages")
            ...
            reflectionHandler = builder
                    .comment("Enable Reflection Handler?")
                    .comment("The reflection handler tries to find all classes that extend EventJS and add them to the KubeJS homepage.")
                    .comment("(Experimental Feature can JVM in some instances and not produce a crash report)")
                    .define("reflectionHandler",false);
            printAllClasses = builder
                    .comment("Forces the reflection handler to print out the names of all classes as it's loading them.")
                    .comment("This will spam the log file so only enable this when you are experiencing crashing issues.")
                    .comment("The latest log should contain the last class that was attempted to be loaded before the crash.")
                    .comment("The package should be added to the blacklisted packages config.")
            ...
            blacklistedPackages = builder
                    ...
                    .comment("If you have AE2 installed and experiencing crashing, try adding \"appeng\".")
