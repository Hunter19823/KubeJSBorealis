...
public class KubeJSEvents {
    public static final String HOMEPAGE_EVENT = "borealis.homepage"; // Documentation: http://localhost:48574/kubejs/kubejs_auto_docs/pie.ilikepiefoo2.kubejsborealis.pages.BorealisHomePageEventJS
    public static final String CUSTOM_PAGE_EVENT = "borealis.page"; // Documentation: http://localhost:48574/kubejs/kubejs_auto_docs/pie.ilikepiefoo2.kubejsborealis.pages.BorealisPageEventJS
    // See below for examples...



    /*
    // Example script for making Borealis homepage entries.
    // Documentation: http://localhost:48574/kubejs/kubejs_auto_docs/pie.ilikepiefoo2.kubejsborealis.pages.BorealisHomePageEventJS
     ...
     */
    /*
    // Example for serving custom Borealis pages.
    // Documentation: http://localhost:48574/kubejs/kubejs_auto_docs/pie.ilikepiefoo2.kubejsborealis.pages.BorealisPageEventJS
    onEvent('borealis.page', event => {
        if(event.checkPath('custom','custom.json')){ // Check the request's path to see if the user is requesting custom/custom.json
            // Test Link: http://localhost:48574/custom/custom.json
            ...
            // Test Link: http://localhost:48574/custom
